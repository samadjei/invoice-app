      ...
      <div>
        <div className='header__right'>
          <div className='header__filters'>
            ...
            {filterOpen ? <div className='filter__card background'>
            <div className="filter__card-container">
                <label className="filter__card-content h3-small text--one">Draft
                  <input id="Draft" name="Draft" value="Draft" type="checkbox"/>
                  <span className="checkmark"></span>
                </label>
                <label className="filter__card-content h3-small text--one">Pending
                  <input id="pending" name="pending" value="pending" type="checkbox"/>
                  <span className="checkmark"></span>
                </label>
                <label className="filter__card-content h3-small text--one">Paid
